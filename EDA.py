...
df["PhysActivity"].value_counts().plot(kind= "bar", cmap="viridis")
plt.xlabel("Physical Activity")
plt.ylabel("Count")
plt.title("Counts of Physical Activity")

# Plot of Physical Activity and Heart Disease
sns.catplot(x = "PhysActivity", hue="HeartDiseaseorAttack", data=df, kind="count", palette = "rocket")
plt.xlabel("Physical Activity")
plt.ylabel("Count")
...
df["HighChol"].value_counts().plot(kind= "bar", cmap="viridis")
plt.xlabel("High Cholesterol")
plt.ylabel("Count")
plt.title("Counts of High Cholesterol")

# Plot of High Cholesterol and Heart Disease
sns.catplot(x = "HighChol", hue="HeartDiseaseorAttack", data=df, kind="count", palette = "rocket")
plt.xlabel("High Cholesterol")
plt.ylabel("Count")
...
sns.catplot(x='Smoker', hue='HeartDiseaseorAttack', data=df, kind='count', palette = "rocket")
...
#%%
#Smoker vs Sex
sns.countplot(x='Sex', data=df, hue='Smoker', palette = "rocket")
...
sns.countplot(x='Sex',data=df, hue='HeartDiseaseorAttack', palette = "rocket")
...
sns.catplot(x='Diabetes', hue='HeartDiseaseorAttack', data=df, kind='count', palette = "rocket")
...
#%%
#Plot for all the variables vs HeartDiseaseorAttack along with the ttest.

catcol = ['CholCheck', 'Stroke', 'AnyHealthcare', 'NoDocbcCost', 'GenHlth', 'MentHlth', 'PhysHlth', 'DiffWalk', 'Sex', 'Education']
